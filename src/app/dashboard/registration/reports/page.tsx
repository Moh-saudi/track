...
export default function RegistrationReportsPage() {
  ...
  return (
    <div className="space-y-6">
      {/* رأس الصفحة وأزرار التنقل والطباعة */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 pb-4 print:hidden">
        ...
        <div className="flex items-center gap-2">
          <Link
            ...
            className="px-3.5 py-2 rounded-lg bg-white border border-slate-300 text-slate-700 text-xs font-bold hover:bg-slate-50 shadow-sm"
          >
            📋 سجل القضايا
          </Link>
          <button
            ...
            className="px-3.5 py-2 rounded-lg bg-white border border-slate-300 text-slate-700 text-xs font-bold hover:bg-slate-50 shadow-sm disabled:opacity-50"
          >
            📥 تصدير Excel
          </button>
          <button
      ...
      <div className="grid grid-cols-2 sm:grid-cols-5 gap-3">
        ...
        <div className="stat-card">
          <div className="stat-icon bg-purple-50 text-purple-700 border border-purple-200">
            📈
          </div>
          <div>
      ...
      <div className="flex items-center gap-2 border-b border-slate-200 pb-2 print:hidden">
        ...
        >
          📋 قائمة السجلات والتقرير التفصيلي ({formatNumber(data?.cases.length)})
        </button>
        ...
        >
          👥 معدلات تشغيل الحسابات منفصلة ({formatNumber(data?.usersWorkload.length)})
        </button>
      </div>
                        ...
                        <td>
                          <div className="flex items-center gap-2">
                            <div className="w-24 bg-slate-200 rounded-full h-2 overflow-hidden">
                              <div
                                className="bg-[#1F4E79] h-2 rounded-full"
